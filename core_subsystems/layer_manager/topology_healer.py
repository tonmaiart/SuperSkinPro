"""Pure topology-aware auto-healing for layer & mask storage.
...
from .compositor import mask_value
...
def heal_layer_dict(layer_dict, neighbours, num_verts):
    ...
    # Multi-pass interpolation for new vertices
    ...
    if missing:
        ...
        # Second / third pass — chain-interpolate vertices whose neighbours
