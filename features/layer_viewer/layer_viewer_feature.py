...
class LayerViewerFeature(UnifiedFeatureExtension):
    ...
    def draw_section(self, layout, context) -> None:
        ...
        if in_pose_mode:
            selector_row.operator("superskin.layer_enter_pose_mode", text="", icon='ARMATURE_DATA')
        else:
            selector_row.operator("superskin.layer_enter_pose_mode", text="", icon='OBJECT_DATAMODE')
