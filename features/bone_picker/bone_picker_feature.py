...
class SSPrefBonePicker(bpy.types.PropertyGroup):
    ...
    no_influence_color: bpy.props.FloatVectorProperty(
        name="No Influence", subtype='COLOR', size=4, min=0.0, max=1.0,
        default=(0.5, 0.5, 0.5, 0.35),
        description="Color for deform bones with zero weight anywhere on the active layer -- distinguishes them from bones that do have influence (Default color)",
        update=_on_changed,
    )
...
class BonePickerFeature(UnifiedFeatureExtension):
    ...
    def draw_section(self, layout, context) -> None:
        ...
        for attr, label in (
            ...
            ("no_influence_color",  "No Influence"),
            ("hover_color",          "Hover"),
        ):
    ...
    def populate(self, data: dict) -> None:
        ...
        if "no_influence_color"   in data: bp.no_influence_color   = tuple(data["no_influence_color"])
    ...
    def serialize_into(self, full_dict: dict) -> None:
        ...
        full_dict.setdefault("customize", {})["bone_picker"] = {
            ...
            "no_influence_color":   list(bp.no_influence_color),
