...
class AddonUpdaterRestoreBackup(bpy.types.Operator):
    ...
    def execute(self, context):
        CoreFacade.debug_log("feature_domains", "addon_updater.AddonUpdaterRestoreBackup.execute(): entry")
        # in case of error importing updater
        if updater.invalid_updater:
            return {'CANCELLED'}
...
#
# Engine configuration (repository, backup patterns, skip_tag/select_link
