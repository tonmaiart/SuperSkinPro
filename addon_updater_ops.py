...
def register(bl_info):
    ...
    updater.verbose = False  # set True for development/debug
    ...
    updater.overwrite_patterns = ["*.py", "*.so", "*.png", "*.jpg", "*.json", "README.md", "LICENSE", "blender_manifest.toml"]
