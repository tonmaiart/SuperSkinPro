...
preference sections it backed -- see `features/vgcolor/README.md`. No
UIList classes are currently registered here; the module is kept for the
registration-order bookkeeping documented in `interface/README.md`.
"""
